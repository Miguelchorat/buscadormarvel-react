...
const Listado_personaje = () => {
    ...
    const obtenerDatos =  async () => {
        ...
        if(busqueda=='' ||busqueda==null){
            ...
            api = await fetch('https://gateway.marvel.com/v1/public/characters?limit='+DATOS_POR_PAGINA+'&offset='+indice+'&orderBy='+filtro+'&nameStartsWith='+busqueda+'&ts='+ts+'&apikey='+public_key+'&hash='+hash);
        }        
